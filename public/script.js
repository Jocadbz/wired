    ...
    .then(posts => {
      ...
      posts.forEach(post => {
        ...
        li.innerHTML = `
          ...
          <p>By: ${post.author}${currentUser === 'admin' && post.authorIP ? ' (IP: ' + post.authorIP + ')' : ''} | <a href="comments.html?postId=${post.id}">Comments (${(post.comments || []).length})</a></p>
...
// Function to load comments and full post
...
// Function to show errors (now using alert)
